...
# db.update('users', 6, 'Евгений', 19)
# db.read('users')
#
# import requests
# from PIL import Image
# import io
# API_KEY = '86f96d1e82a270046b1028edfeea3eda'
...
#
# print(f' сегодня  городе {CITY} {weather}')
# print(f' температура: {temperature:.1f}')
# data = result['coord']
...
def logger(func):
    ...
    def decorated_function(*args,**kwargs):
        nonlocal counter
        counter +=1
        print(counter, '->', 'Аргументы', args, 'Исенованные аргументы' ,kwargs)

        result  = func(*args,**kwsrgs)
        print('_________','Результтат: ', result)

        return decorated_function

        def make_burger(mael,onion=False, TOmato = False):
            print('Булочка')
